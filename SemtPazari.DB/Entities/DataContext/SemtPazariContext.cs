...
namespace SemtPazari.DB.Entities.DataContext
{
    public partial class SemtPazariContext : DbContext
    {
        public SemtPazariContext()
        {
        }

        public SemtPazariContext(DbContextOptions<SemtPazariContext> options)
            : base(options)
        {
        }
